...
//import com.badlogic.gdx.sqlite.win.DesktopCursor;
//
...
//
//import static com.badlogic.gdx.sql.builder.android.Keywords.*;
...
//
//
//    public DatabaseCursor getCursor(final Connection connection) throws SQLiteGdxException {
//        DesktopCursor lCursor = new DesktopCursor();
//        try {
//            ResultSet resultSetRef = prepareStatement(connection).executeQuery();
...
//    }
//
//    public DatabaseCursor getCursor(final DatabaseCursor cursor, final Connection connection) throws SQLiteGdxException {
